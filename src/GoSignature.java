...
public class GoSignature
{
	...
	GoSignature( LinkedList<GoParameterDecl> parameters, GoType type )
	{
		this.parameters = parameters;
		this.obj = type;
		// gen();
	}
	GoSignature( LinkedList<GoParameterDecl> parameters1, LinkedList<GoParameterDecl> parameters2 )
	{
		this.parameters = parameters1;
		this.obj = parameters2;
		// gen();
	}
	GoSignature( LinkedList<GoParameterDecl> parameters )
	{
		this.parameters = parameters;
		this.obj = null;
		// gen();

...
public class SymbolTableEntry
{
    ...
    LinkedList<String> addressDescriptor;
    SymbolTableEntry()
    {
        this.dataType = "Bhoot";
    ...
    SymbolTableEntry(String data_type, int global_offset)
    {
    ...
    SymbolTableEntry(int quad_index, String condCheck)
    {
	...
	SymbolTableEntry ( Object dataType, Boolean isConst, int global_offset)
	{
        live =true;
        next_use = -1;
        addressDescriptor = new LinkedList<String>();
